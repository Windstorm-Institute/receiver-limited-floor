...
**Keywords:** M-ary discrimination; receiver constraint; genetic code fidelity; tokenizer vocabulary; bits per byte; cross-architecture compression; language mismatch penalty; information bottleneck; throughput convergence; substrate independence
...
All data, analysis scripts, and experiment protocols supporting the findings of this study are publicly available at https://github.com/Windstorm-Labs/receiver-limited-floor (accessed 12 April 2026).
...
2. Shannon, C.E. A Mathematical Theory of Communication. *Bell Syst. Tech. J.* **1948**, *27*, 379--423. DOI: 10.1002/j.1538-7305.1948.tb01338.x
3. Zaher, H.S.; Green, R. Quality Control by the Ribosome Following Peptide Bond Formation. *Nature* **2009**, *457*, 161--166. DOI: 10.1038/nature07582
4. Miller, G.A.; Nicely, P.E. An Analysis of Perceptual Confusions among Some English Consonants. *J. Acoust. Soc. Am.* **1955**, *27*, 338--352. DOI: 10.1121/1.1907526
5. Berger, T. *Rate Distortion Theory*; Prentice-Hall: Englewood Cliffs, NJ, USA, 1971.
6. Whitmer, G.L., III. Receiver-Limited Floor: Experiment Code and Data. *GitHub* **2026**. Available online: https://github.com/Windstorm-Labs/receiver-limited-floor (accessed 12 April 2026).
...
8. Hopfield, J.J. Kinetic Proofreading: A New Mechanism for Reducing Errors in Biosynthetic Processes Requiring High Specificity. *Proc. Natl. Acad. Sci. USA* **1974**, *71*, 4135--4139. DOI: 10.1073/pnas.71.10.4135
9. Whitmer, G.L., III. The Throughput Basin: Cross-Substrate Convergence and Decomposition of Serial Decoding Throughput. *Zenodo* **2026**. DOI: 10.5281/zenodo.19323194
10. Borst, A.; Theunissen, F.E. Information Theory and Neural Coding. *Nat. Neurosci.* **1999**, *2*, 947--957. DOI: 10.1038/14731
11. Whitmer, G.L., III. The Serial Decoding Basin: Five Experiments on Convergence, Thermodynamic Anchoring, and Receiver-Limited Geometry. *Zenodo* **2026**. DOI: 10.5281/zenodo.19323423
12. Whitmer, G.L., III. The Dissipative Decoder: Thermodynamic Cost Bounds on the Serial Decoding Throughput Basin. *Zenodo* **2026**. DOI: 10.5281/zenodo.19433048
13. Whitmer, G.L., III. The Inherited Constraint: Biological Throughput Limits Shape the Information Structure of Human Language and AI. *Zenodo* **2026**. DOI: 10.5281/zenodo.19432911
14. Whitmer, G.L., III. The Throughput Basin Origin: Four Orthogonal Experiments on Whether Serial Decoding Convergence Is Architectural, Thermodynamic, or Data-Driven. *Zenodo* **2026**. DOI: 10.5281/zenodo.19498582
15. Whitmer, G.L., III. The Receiver-Limited Floor: Rate-Distortion Bounds on Serial Decoding Throughput. *Zenodo* **2026**. DOI: 10.5281/zenodo.19322973

---

## Appendix A. Experiment Protocol

The complete experiment protocol, including hardware specifications, corpus preparation, BPB computation methods for three model formats (HuggingFace, GGUF, MarianMT), statistical analysis procedures, and visualization specifications, is provided in the supplementary file APPENDIX-A-EXPERIMENT-PROTOCOL.md [6]. The protocol was designed for full reproducibility: any researcher with access to HuggingFace models and a CUDA-capable GPU can replicate the experiment using the provided instructions.
...
*This paper is Paper 2 of The Windstorm Series. The series includes Paper 1: The Fons Constraint [1], Paper 3: The Throughput Basin [9], Paper 4: The Serial Decoding Basin [11], Paper 5: The Dissipative Decoder [12], Paper 6: The Inherited Constraint [13], and Paper 7: The Throughput Basin Origin [14].*
